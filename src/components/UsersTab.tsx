	...
	return (
		<div>
				...
				<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
					<div className="bg-white rounded-lg shadow-2xl p-6 max-w-md w-full">
						...
						<div className="space-y-3 mb-6">
							<div>
								<label className="block text-sm font-semibold text-gray-700 mb-1">For</label>
			...
			<div className="bg-gray-50 p-4 rounded-lg mb-6">
				<h3 className="text-lg font-semibold text-gray-800 mb-3">Create New User Account</h3>
			...
			{/* Users List */}
			<div>
				<h3 className="text-indigo-600 text-xl font-semibold mb-3">Existing Users</h3>
				...
				{loading ? (
					...
					<div className="space-y-3">
						{users.map((user) => (
							<div key={user.id} className="bg-gray-50 p-4 rounded-lg flex justify-between items-center">
